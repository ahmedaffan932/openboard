...
LOCAL_CFLAGS += -Wno-unused-parameter -Wno-unused-function -Wno-unused-but-set-variable \
    -Wno-deprecated-copy
...
LOCAL_SDK_VERSION := 14
LOCAL_NDK_STL_VARIANT := c++_static
LOCAL_LDFLAGS += -ldl -Wl,-z,max-page-size=16384 -Wl,-z,common-page-size=16384
